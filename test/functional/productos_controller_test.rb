...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { encodedsqlrow: @producto.encodedsqlrow, nombre: @producto.nombre, precio: @producto.precio }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { encodedsqlrow: @producto.encodedsqlrow, nombre: @producto.nombre, precio: @producto.precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
